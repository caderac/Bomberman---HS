...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        bool restart, other, trans, grow, shrink;
        ...
        public Form1()
        {
            ...
            pfd.AddFontFile(@"C:\Users\Cole Cadera\Desktop\BomberMan V1.6\BomberMan V1.0\Resources\Digital-Desolation.ttf");
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (gameOnOff == true)
            {
                ...
                for (int n = 0; n < Players.Count - plNum; n++)
                {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyData == Keys.Home) { Transition(); } 
        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            if (gameOnOff == false)
            {
                ...
                if (mPos == 1) { Transition(); }
                if (mPos == 2) { Transition(); }
                if (mPos == 3) { this.Close(); }
            }

            if (inGameMenu == true && gameOnOff == true) 
            {
        ...
        private void Form1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (gameOnOff == true && inGameMenu == true)
            {
                mPos = -1;
        ...
        private void Transition() 
        {
            ...
            grow = true;
                ...
                if (other == true) 
                {
                    gameOnOff = false; mPos = -1; DrawBackGround(); this.Refresh();
                }
