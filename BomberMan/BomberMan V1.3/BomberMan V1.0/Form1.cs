    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            /*for (int n = 0; n < pu.Count; n++)
            {
                ...
                //e.Graphics.DrawString("" + skull, new System.Drawing.Font("Lucida Console", 15), Brushes.White, this.Width - 100, 300);
                    ...
                    if (pTemp[pTemp.Count - 1] >= 5 && pTemp[pTemp.Count - 1] <= 19)
                    {
                        ...
                        if (pTemp[pTemp.Count - 1] >= 20 && pTemp[pTemp.Count - 1] <= 34)
                        {
                            ...
                            if (pTemp[pTemp.Count - 1] >= 35 && pTemp[pTemp.Count - 1] <= 49)
                            {
                                ...
                                if (pTemp[pTemp.Count - 1] >= 50 && pTemp[pTemp.Count - 1] <= 59)
                                {
                                    ...
                                    if (pTemp[pTemp.Count - 1] >= 60 && pTemp[pTemp.Count - 1] <= 69)
                                    {
