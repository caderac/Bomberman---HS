...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //Start off music
            wp.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Menu.mp3";
            ...
            pfd.AddFontFile(@"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Digital-Desolation.ttf");        
            ...
            optButt.Add(pin);
            //Option Control BTNS
            optButCon.Add(new Rectangle(70, 125, 100, 50));
            optButCon.Add(new Rectangle(230, 125, 100, 50));
            optButCon.Add(new Rectangle(390, 125, 100, 50));
            optButCon.Add(new Rectangle(550, 125, 100, 50));
            optButCon.Add(new Rectangle(230, 225, 260, 50));
            optButCon.Add(new Rectangle(70, 225, 100, 50));
            optButCon.Add(new Rectangle(550, 225, 100, 50));
            optButtCon.Add(off);
            optButtCon.Add(off);
            optButtCon.Add(off);
            optButtCon.Add(on);
            ...
            if (gameOnOff == true && inGameMenu == false)
            {
                ...
                if (endTmr == true && won == false) 
                {
                    ...
                    if (plWins[0] == winsNeeded || plWins[1] == winsNeeded || plWins[2] == winsNeeded || plWins[3] == winsNeeded) 
                    {
                        ...
                        //temp
                        won = true;
                        wp.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Cantina.mp3";
                    }
                }               
            }            
            this.Refresh();
                ...
                for (int n = 0; n < Players.Count; n++)
                {
                    for (int i = 0; i < power.Count; i++)
                    {
                        ...
                        if (Players[n].IntersectsWith(power[i]) && skPl != n)
                        {
                            if (lWP == 1)
                            {
                                wpL1.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Mafia.mp3";
                                lWP += 1;
                            }
                            else
                                if (lWP == 2)
                                {
                                    wpL2.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Mafia.mp3";
                                    lWP += 1;
                                }
                                else
                                    if (lWP == 3)
                                    {
                                        wpL3.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Mafia.mp3";
                                        lWP = 1;
                                    }
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (gameOnOff == false) 
            {
                ...
                if (oOn == true)
                {
                    ...
                    e.Graphics.FillRectangle(Brushes.Black, 0, 30, this.Width, 60);
                    e.Graphics.DrawString("OPTIONS", new System.Drawing.Font(pfd.Families[0], 15), Brushes.White, 270, 50);
                    e.Graphics.DrawString("Rnd Spawn", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 77, 145);
                    e.Graphics.DrawString("Rnd Color", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 237, 145);
                    e.Graphics.DrawString("Power Up", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 402, 132);
                    e.Graphics.DrawString("Cahnce", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 407, 142);
                    e.Graphics.DrawString("Score Limit", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 317, 232);
                    e.Graphics.DrawString("<", new System.Drawing.Font(pfd.Families[0], 10), Brushes.White, 110, 242);
                    e.Graphics.DrawString(">", new System.Drawing.Font(pfd.Families[0], 10), Brushes.White, 595, 242);
                    e.Graphics.DrawString("Imovable", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 562, 140);
                    e.Graphics.DrawString("Bombs", new System.Drawing.Font(pfd.Families[0], 6), Brushes.White, 577, 150);
                    if (winsNeeded == 1)
                    {
                        e.Graphics.DrawString("" + winsNeeded, new System.Drawing.Font(pfd.Families[0], 10), Brushes.White, 357, 249);
                    }
                    else
                    {
                        e.Graphics.DrawString("" + winsNeeded, new System.Drawing.Font(pfd.Families[0], 10), Brushes.White, 355, 249);                    
                    }
                    if (puSpawnRate == 2)
                    {
                        e.Graphics.DrawString("50%", new System.Drawing.Font(pfd.Families[0], 7), Brushes.White, 420, 157);
                    }
                    if (puSpawnRate == 4)
                    {
                        e.Graphics.DrawString("25%", new System.Drawing.Font(pfd.Families[0], 7), Brushes.White, 420, 157);
                    }
                    if (puSpawnRate == 10)
                    {
                        e.Graphics.DrawString("10%", new System.Drawing.Font(pfd.Families[0], 7), Brushes.White, 422, 157);
                    }
                    if (puSpawnRate == 1)
                    {
                        e.Graphics.DrawString("ALMOST 100%", new System.Drawing.Font(pfd.Families[0], 5), Brushes.White, 395, 157);
                    }
                    if (mPos >= 0 &&  mPos <= 7 && mPos != 4)
                    {
            ...
            {               
                  boCou[n] += 1;
                    ...
                    if (boCou[n] == 4)
                    {
                        if (bWP == 1)
                        {
                            wpB1.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\EXPC.mp3";
                            bWP += 1;
                        }
                        else
                            if (bWP == 2)
                            {
                                wpB2.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\EXPC.mp3";
                                bWP += 1;
                            }
                            else
                                if (bWP == 3)
                                {
                                    wpB3.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\EXPC.mp3";
                                    bWP = 1;
                                }
                    }
                if (boCou[n] >= boTC)
        ...
        private void Transition() 
        {
            ...
            grow = true;
                ...
                if (restart == true) 
                {
                    Reset(); gameOnOff = true; DrawBackGround(); inGameMenu = false; wp.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Melody.mp3";
                }
                if (other == true) 
                {
                    gameOnOff = false; mPos = -1; cOn = false; oOn = false; if (won == true) { wp.URL = @"C:\Users\dtast\Desktop\BomberMan V1.7\BomberMan V1.0\Resources\Menu.mp3"; } Reset(); DrawBackGround(); this.Refresh();
                }
                if (controls == true)
                {
